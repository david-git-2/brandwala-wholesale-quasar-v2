...
| **T3** | Stock grade FK | Same as procurement **W7** — `global_stocks.grade_tag_id`; receive → `standard`; movements change grade; warehouse list shows grade. W8 organize-by-shipment and W9 return inbound are done. | ✅ Done |
