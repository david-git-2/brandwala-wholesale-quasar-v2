...
| **T3** | Stock grade FK | Same as procurement **W7** — `global_stocks.grade_tag_id`; receive → `standard`; movements change grade — [../procurement_stock/IMPLEMENTATION_ORDER.md](../procurement_stock/IMPLEMENTATION_ORDER.md) | 🔜 Next (W7) |
