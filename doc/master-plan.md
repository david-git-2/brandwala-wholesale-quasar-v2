...
TradeFlow BD is an enterprise multi-tenant ERP and commerce platform designed for **companies** and their **brands** (child tenants) operating wholesale distribution, warehouse fulfillment, dropship networks, and specialized retail verticals.
...
1. **Single Physical Stock Pool**: Physical inventory is owned exclusively at the **company** (parent tenant) level (`global_stocks`). **Brands** consume stock via virtual allocations without duplicating physical stock rows.
2. **Atomic Single-Invoice Ownership**: Sales invoices (`global_invoices`) are owned by the company for consolidated ledger auditing, with `issued_by_tenant_id` preserving brand desk identity and customer relationships.
...
All domain specifications, page matrices, and engine algorithms are maintained across these canonical documents:
...
* [`doc/after_sales/AFTER_SALES.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/AFTER_SALES.md): Parent-configurable return, replacement, and warranty; wholesale + dropship channels; parent/child processing. **Returns Hub:** [`RETURNS_HUB.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/RETURNS_HUB.md). Channel specs: [`WHOLESALE_AFTER_SALES.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/WHOLESALE_AFTER_SALES.md), [`DROPSHIP_AFTER_SALES.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/DROPSHIP_AFTER_SALES.md). Phases: [`IMPLEMENTATION_ORDER.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/IMPLEMENTATION_ORDER.md). **Execution tasks:** [`TASK.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/TASK.md). UI: [`UI_FLOW.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/after_sales/UI_FLOW.md).
...
* [`doc/shop_order/SHOP_ORDER.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/SHOP_ORDER.md): Shop setup hub (`shop_config`), B2B storefront commerce (`shop` scope), and Dropship Reseller Desk (`app` scope) with the 3-step Dropship Finance Hub. UI flows: [`UI_FLOW.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/UI_FLOW.md). Dropship processing stock pick: [`DROPSHIP_PROCESSING_STOCK_PICK.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/DROPSHIP_PROCESSING_STOCK_PICK.md). Catalog negotiation: [`CATALOG_NEGOTIATION.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/CATALOG_NEGOTIATION.md). Demand bucket: [`DEMAND_BUCKET.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/DEMAND_BUCKET.md). Procurement demand list: [`PROCUREMENT_DEMAND_LIST.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/PROCUREMENT_DEMAND_LIST.md). Customer groups: [`CUSTOMER.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/customer/CUSTOMER.md). Shop look (tokens, not layout): [`doc/fix/SHOP_SCOPE_VISUAL_REDESIGN.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/fix/SHOP_SCOPE_VISUAL_REDESIGN.md).
