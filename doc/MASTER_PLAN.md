...
* [`doc/shop_order/SHOP_ORDER.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/SHOP_ORDER.md): Shop setup hub (`shop_config`), B2B storefront commerce (`shop` scope), and Dropship Reseller Desk (`app` scope) with the 3-step Dropship Finance Hub. UI flows: [`UI_FLOW.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/shop_order/UI_FLOW.md). Customer groups: [`CUSTOMER.md`](file:///Users/daviditc/Documents/personal_projects/brandwala-wholesale-quasar-v2/doc/customer/CUSTOMER.md).
