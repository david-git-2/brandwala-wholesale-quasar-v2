...
**Note:** iOS Safari only works when site is added to Home Screen (iOS 16.4+). Brave blocks Google push — use Chrome. Telegram (Phase 3) remains the reliable iPhone channel. Capacitor Android is a separate track.
