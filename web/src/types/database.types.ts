  ...
  public: {
    Tables: {
      ...
      batch_code_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "batch_code_items_list_id_fkey"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "batch_code_lists"
            referencedColumns: ["id"]
          },
        ]
      }
      batch_code_lists: {
        ...
        Relationships: [
          {
            foreignKeyName: "batch_code_lists_parent_tenant_id_fkey"
          ...
          {
            foreignKeyName: "batch_code_lists_shipment_id_fkey"
            columns: ["shipment_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "batch_code_lists_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
      ...
      customer_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "customer_groups_parent_tenant_id_fkey"
            columns: ["parent_tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      invoice_brands: {
        ...
        Relationships: [
          {
            foreignKeyName: "invoice_brands_parent_tenant_id_fkey"
            columns: ["parent_tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_operating_tenant_id_fkey"
          ...
          {
            foreignKeyName: "notifications_parent_tenant_id_fkey"
            columns: ["parent_tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_based_costing_files: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "product_based_costing_files_customer_group_id_fkey"
            columns: ["customer_group_id"]
            isOneToOne: false
            referencedRelation: "customer_groups"
            referencedColumns: ["id"]
      ...
      shop_cart_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shop_cart_items_grade_tag_id_fkey"
            columns: ["grade_tag_id"]
            isOneToOne: false
            referencedRelation: "tags"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shop_cart_items_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
      ...
      shop_order_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shop_order_items_grade_tag_id_fkey"
            columns: ["grade_tag_id"]
            isOneToOne: false
            referencedRelation: "tags"
            referencedColumns: ["id"]
      ...
      shop_product_listings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shop_product_listings_grade_tag_id_fkey"
            columns: ["grade_tag_id"]
            isOneToOne: false
            referencedRelation: "tags"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      create_invoice_from_preorder_demand_document: {
        Args: {
      ...
      current_selected_customer_group_id: { Args: never; Returns: number }
      ...
      find_customer_admin_email_conflict: {
        Args: {
          ...
          p_exclude_customer_group_id?: number
          p_exclude_member_id?: number
          p_tenant_id: number
        }
        Returns: string
      }
      find_customer_create_conflict: {
        Args: {
          p_group_name?: string
          p_phone?: string
          p_phone_country_code?: string
      ...
      has_shop_notification_access: {
        Args: { p_tenant_id: number }
        Returns: boolean
      }
      hold_shop_grade_stock_for_order: {
        Args: {
      ...
      is_tenant_manager: { Args: { p_tenant_id: number }; Returns: boolean }
      ...
      list_customer_accounts_paginated: {
        Args: {
          p_page?: number
          p_page_size?: number
          p_search?: string
      ...
      list_invoice_payment_history: {
        Args: { p_invoice_id: number; p_tenant_id: number }
        Returns: Json
      }
      ...
      normalize_customer_national_phone: {
        Args: { p_phone: string }
        Returns: string
      }
      ...
      paste_batch_code_items: {
        Args: { p_list_id: number; p_rows: Json; p_start_row_index: number }
        Returns: Json
      }
      ...
      resolve_customer_group_notification_user_ids: {
        Args: { p_customer_group_id: number }
        Returns: string[]
      }
      ...
      set_notification_dispatch_settings: {
      ...
      shop_product_grade_avg_landed_cost: {
        Args: {
          p_grade_tag_id: number
          p_product_id: number
          p_shop_tenant_id: number
      ...
      shop_shipment_alloc_visible_to_tenant: {
        Args: { p_assigned_child_tenant_id: number; p_shop_tenant_id: number }
        Returns: boolean
      }
      ...
      transfer_network_owner: {
        Args: { p_new_email: string; p_parent_tenant_id: number }
        Returns: Json
      }
      ...
      update_payment_instrument_details: {
        Args: {
          p_bd_bank_id?: number
      ...
      void_customer_receipt: {
        Args: { p_payment_id: number; p_reason: string; p_tenant_id: number }
        Returns: Json
      }
      void_global_invoice: {
        Args: { p_invoice_id: number }
