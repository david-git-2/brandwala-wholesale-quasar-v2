...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      global_invoices: {
        Row: {
          ...
          retail_billing_mode: Database['public']['Enums']['retail_billing_mode'] | null;
      ...
      thrift_invoice_items: {
        Row: {
          ...
          quantity: number;
          return_action: Database['public']['Enums']['thrift_return_action'] | null;
    ...
    Enums: {
      ...
      commerce_order_status: 'placed' | 'reviewing' | 'shipping' | 'delivered' | 'cancelled';
      ...
      shop_order_mode_enum: 'procurement_intent' | 'checkout_fixed' | 'checkout_wholesale';
      shop_order_status:
        | 'draft'
        | 'submitted'
        | 'cancelled'
      ...
      thrift_delivery_status:
        'PENDING' | 'SHIPPED' | 'DELIVERED' | 'RETURNED' | 'PARTIALLY_RETURNED';
...
export const Constants = {
  public: {
    Enums: {
      ...
      shop_type_enum: ['vendor_catalog', 'fixed_price', 'dropship'],
      thrift_condition: ['NEW_WITH_TAGS', 'EXCELLENT', 'GOOD', 'FAIR'],
      thrift_delivery_status: ['PENDING', 'SHIPPED', 'DELIVERED', 'RETURNED', 'PARTIALLY_RETURNED'],
      thrift_item_status: ['SOLD', 'RETURNED'],
      thrift_ledger_source: ['INVOICE', 'SHIPMENT', 'OPERATIONAL'],
      thrift_ledger_type: ['REVENUE', 'EXPENSE', 'REFUND', 'LOSS'],
      thrift_payment_status: ['UNPAID', 'PAID', 'REFUNDED'],
