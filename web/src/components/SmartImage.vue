<template>
  ...
  >
    ...
    <template v-else>
      <div class="smart-image__fallback">No Image</div>
    </template>
    ...
    <q-dialog v-model="dialogOpen" @click.stop>
      <q-card style="width: 400px; max-width: 90vw" class="q-pa-md">
        ...
        <q-card-section class="q-pa-none q-mb-md">
          ...
          <div
            class="preview-box border-grey rounded-borders flex flex-center q-pa-sm bg-grey-2"
        ...
        <q-card-actions align="right" class="q-pa-none">
          ...
          <q-btn color="primary" label="Update" :loading="updating" @click="onUpdate" no-caps />
        </q-card-actions>
      </q-card>
    </q-dialog>
...
const isAdmin = computed(() => {
  return (
    authStore.scope === 'app' &&
    (authStore.matchedRole === 'admin' || authStore.matchedRole === 'superadmin')
  );
});
