...
const createModule = async (module: ModuleCreateInput): Promise<ModuleServiceResult<Module>> => {
  try {
...
const updateModule = async (module: ModuleUpdateInput): Promise<ModuleServiceResult<Module>> => {
  try {
...
const deleteModule = async (module: ModuleDeleteInput): Promise<ModuleServiceResult<Module>> => {
  try {
