...
const createMarket = async (market: MarketCreateInput): Promise<MarketServiceResult<Market>> => {
  try {
...
const updateMarket = async (market: MarketUpdateInput): Promise<MarketServiceResult<Market>> => {
  try {
...
const deleteMarket = async (market: MarketDeleteInput): Promise<MarketServiceResult<Market>> => {
  try {
