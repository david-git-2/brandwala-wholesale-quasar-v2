  ...
  <q-page class="q-pa-md tenant-details-page">
    <div class="q-gutter-y-md">
      ...
      <section class="row items-center justify-between q-col-gutter-md">
        ...
        <div v-if="tenant" class="col-auto row q-gutter-sm items-center">
          <q-btn
            color="primary"
            unelevated
            no-caps
      ...
      <q-banner v-if="pageError" class="bg-negative text-white" rounded>
        {{ pageError }}
      </q-banner>

      <!-- Skeleton Loading State (SKELETON_LOADERS.md) -->
      <template v-if="pageLoading">
        <div class="row q-col-gutter-md">
          <!-- Left Column Skeleton -->
          <div class="col-12 col-lg-5">
            <q-card flat bordered class="q-pa-md">
              <q-skeleton type="text" width="140px" height="24px" class="q-mb-md" />
              <div v-for="i in 5" :key="i" class="row justify-between items-center q-py-sm">
          ...
          <div class="col-12 col-lg-7 q-gutter-y-md">
            <q-card flat bordered class="q-pa-md">
              <q-skeleton type="text" width="120px" height="24px" class="q-mb-md" />
                        ...
                        <q-item>
                          ...
                          <q-item-section side>
                            <q-btn
                              ...
                              no-caps
                              label="Add"
                              :loading="actionLoadingKey === feature.key"
                        ...
                        <q-item>
                          ...
                          <q-item-section side>
                            <q-btn
                              ...
                              no-caps
                              label="Remove"
                              :loading="actionLoadingKey === feature.module_key"
...
const addTenantFeature = async (moduleKey: string) => {
  if (!tenant.value?.id) return;
  actionLoadingKey.value = moduleKey;
  try {
...
const removeTenantFeature = async (moduleId: number) => {
  if (!tenant.value?.id) return;
  const targetModule = modules.value.find((m) => m.id === moduleId);
  if (!targetModule) return;

  const parentKey = targetModule.module_key;
  actionLoadingKey.value = parentKey;
  try {
