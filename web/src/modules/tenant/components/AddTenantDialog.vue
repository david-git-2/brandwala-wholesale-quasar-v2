  ...
  <q-dialog v-model="localModelValue" persistent>
    <q-card style="min-width: 400px; max-width: 90vw">
      ...
      <q-card-section class="q-gutter-md">
        ...
        <q-toggle v-model="form.is_active" label="Is Active" />

        <div v-if="isEdit" class="tenant-meta">
          <div class="text-subtitle2">Tenant Details</div>

          <q-input :model-value="form.id ?? ''" label="Tenant ID" outlined dense readonly />
...
const parentOptions = computed(() => {
  ...
  return [{ label: 'None (Root Tenant)', value: null }, ...options];
});
