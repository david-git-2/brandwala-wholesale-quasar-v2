...
): Promise<ProductBasedCostingServiceResult<ProductBasedCostingFileListPage>> => {
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to load product based costing files.',
    };
  }
};
...
const createProductBasedCostingFile = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to create product based costing file.',
    };
  }
};
...
const updateProductBasedCostingFile = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to update product based costing file.',
    };
  }
};
...
const deleteProductBasedCostingFile = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to delete product based costing file.',
    };
  }
};
...
const getProductBasedCostingFileById = async (
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to load product based costing file.',
    };
  }
};
...
const listProductBasedCostingItems = async (
  ...
  try {
    const data =
      await productBasedCostingRepository.listProductBasedCostingItems(productBasedCostingFileId);
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to load product based costing items.',
    };
  }
};
...
const createProductBasedCostingItem = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to create product based costing item.',
    };
  }
};
...
const updateProductBasedCostingItem = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to update product based costing item.',
    };
  }
};
...
const deleteProductBasedCostingItem = async (
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : 'Failed to delete product based costing item.',
    };
  }
};
...
const getProductBasedCostingItemById = async (
  ...
  try {
    ...
    return {
      success: false,
      error: error instanceof Error ? error.message : 'Failed to load product based costing item.',
    };
  }
};
