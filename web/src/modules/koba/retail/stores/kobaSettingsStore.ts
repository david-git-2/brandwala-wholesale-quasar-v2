...
import {
  kobaSettingsRepository,
  type KobaRetailSettings,
} from '../repositories/kobaSettingsRepository';
      ...
      try {
        ...
        if (data) {
          ...
          this.settings = {
            ...
            tenant_id: tenantId,
            cod_charge_pct: 1.0,
            gateway_charge_flat: 20.0,
            packing_charge_flat: 37.0,
            invoice_charge_flat: 1.0,
            extra_profit_user_pct: 90.0,
            extra_profit_company_pct: 10.0,
