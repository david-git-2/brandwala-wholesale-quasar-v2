  ...
  <q-page class="q-pa-md bw-page">
    ...
    <div class="row items-center justify-between q-mb-md">
      <div>
        ...
        <div class="text-caption text-grey-7">Track customer demand, metrics, and ordering frequency</div>
      </div>
      <q-btn
        flat
        round
        ...
        <template #body-cell-name="props">
          <q-td :props="props">
            <div class="row items-center q-gutter-xs">
              ...
              <div class="q-ml-sm">
                <div class="text-weight-medium text-grey-9">{{ props.row.name || 'Walk-in Customer' }}</div>
        ...
        <template #body-cell-location="props">
          <q-td :props="props">
            <div v-if="props.row.district" class="text-grey-8">
              {{ props.row.district }}
              <span v-if="props.row.thana" class="text-grey-6 text-caption">({{ props.row.thana }})</span>
            </div>
        ...
        <template #body-cell-actions="props">
          <q-td :props="props" align="right">
            <q-btn
              ...
              icon="analytics"
              size="sm"
              :to="{ name: 'app-koba-retail-customer-profile-page', params: { phone: props.row.phone } }"
            >
