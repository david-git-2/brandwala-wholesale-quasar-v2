...
export const kobaSettingsRepository = {
  async getSettings(tenantId: number): Promise<{ data: KobaRetailSettings | null; error: PostgrestError | null }> {
  ...
  async updateSettings(settings: Partial<KobaRetailSettings>): Promise<{ data: KobaRetailSettings | null; error: PostgrestError | null }> {
