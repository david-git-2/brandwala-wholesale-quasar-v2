    ...
    <div class="bw-page__stack">
      ...
      <div v-else-if="orderStore.orders.length === 0" class="column items-center justify-center empty-state q-pa-xl text-center">
        ...
        <p class="text-body2 text-grey-5 q-mt-sm q-mb-md">
          Browse the catalog, add items to your cart, and place an order to get started.
p        </p>
        <q-btn color="primary" no-caps label="Go Browse Catalog" class="pill-btn" @click="goToStorefront" />
      </div>
                ...
                <div class="row items-center justify-between q-col-gutter-sm">
                  ...
                  <div class="col-xs-12 col-sm-4 row items-center q-gutter-x-lg">
                    <div class="column">
                      ...
                      <span class="text-body2 text-weight-bold text-grey-8">{{ order.item_count }} items</span>
                    </div>
                    <div class="column">
