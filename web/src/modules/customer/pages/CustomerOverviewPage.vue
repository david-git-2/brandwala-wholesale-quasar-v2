...
const hubCards: HubCard[] = [
  {
    ...
    path: 'list',
    title: 'Customers',
    caption: 'Customer groups, billing profiles, members, and wallets.',
    icon: 'ph ph-users',
  ...
  },
  {
    ...
    title: 'Recipients',
    caption: 'Delivery and drop-ship address profiles.',
...
const goTo = (path: string) => {
  void router.push(`${getTenantPrefix()}/app/customers/${path}`);
};
</script>
