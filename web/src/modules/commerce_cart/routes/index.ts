...
const commerceCartRoutes: RouteRecordRaw[] = [
  {
    path: '/:tenantSlug?/shop/commerce-shop/cart',
    component: () => import('layouts/ShopLayout.vue'),
    children: [
      {
        path: '',
        name: 'shop-commerce-cart-page',
        component: () => import('../pages/CustomerCommerceCartPage.vue'),
...
export default commerceCartRoutes
