<template>
  <q-page class="q-pa-xs q-sm-pa-md accounting-dashboard">
    <!-- ── Hero Header ──────────────────────────────────────── -->
        ...
        <div class="row items-center justify-between q-col-gutter-sm">
          <div class="col-12 col-sm">
            ...
            <div class="text-caption text-grey-8 q-mt-xs">
              Manage unified ledger entries, customer billing/payments, shipments, and inventory summaries.
            </div>
          </div>
        </div>
      </q-card-section>
    ...
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card
          ...
          @click="navigateTo('app-accounting-invoice-page')"
        >
          <q-card-section class="column justify-between full-height q-pa-lg">
            <div class="column q-gutter-y-sm">
              ...
              <div class="text-caption text-grey-7">
                Track payments, cost of goods sold (COGS), total revenues, and profit margins on standard invoices.
              </div>
            </div>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card
          flat
          class="dashboard-card cursor-pointer floating-surface shadow-1 hover-scale"
          @click="navigateTo('app-accounting-customer-payments-page')"
        >
          <q-card-section class="column justify-between full-height q-pa-lg">
            <div class="column q-gutter-y-sm">
              ...
              <div class="text-subtitle1 text-weight-bold text-grey-9 q-mt-md">Customer Payments</div>
              <div class="text-caption text-grey-7">
                Manage billing profiles, receive customer payments, and view ledger balances and payment histories.
              </div>
            </div>
            <div class="row items-center justify-between q-mt-lg text-primary text-weight-medium text-caption">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card
          flat
          class="dashboard-card cursor-pointer floating-surface shadow-1 hover-scale"
          @click="navigateTo('app-accounting-shipment-page')"
        >
          <q-card-section class="column justify-between full-height q-pa-lg">
            <div class="column q-gutter-y-sm">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card
          flat
          class="dashboard-card cursor-pointer floating-surface shadow-1 hover-scale"
          @click="navigateTo('app-accounting-inventory-shipment-page')"
        >
          <q-card-section class="column justify-between full-height q-pa-lg">
            <div class="column q-gutter-y-sm">
