<template>
  <q-dialog :model-value="modelValue" @update:model-value="emit('update:modelValue', $event)">
    <q-card style="min-width: 420px; max-width: 96vw">
      <q-card-section class="text-h6">Edit Commerce Billing Profile</q-card-section>
...
import type { CommerceBillingProfile } from '../repositories/commerceBillingProfileRepository'

const props = defineProps<{
  modelValue: boolean
  profile: CommerceBillingProfile | null
  saving?: boolean
}>()
