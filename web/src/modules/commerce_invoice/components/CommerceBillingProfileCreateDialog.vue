<template>
  <q-dialog :model-value="modelValue" @update:model-value="onDialogToggle">
    <q-card style="min-width: 420px; max-width: 96vw">
      <q-card-section class="text-h6">Create Commerce Billing Profile</q-card-section>
...
import type { CreateCommerceBillingProfileInput } from '../repositories/commerceBillingProfileRepository'
...
const emit = defineEmits<{
  ...
  (e: 'submit', payload: CreateCommerceBillingProfileInput): void
}>()
