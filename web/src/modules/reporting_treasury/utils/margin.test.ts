...
describe('Reporting Treasury Margin Formulas', () => {
  ...
  describe('invoiceGrossProfit - Wholesale', () => {
    ...
    const lines: (LineInput & { id: number })[] = [
      { id: 1, sell_price_amount: 120, unit_cost_price: 80, quantity: 10, line_discount_amount: 20 }, // GP: 380
  ...
  describe('invoiceGrossProfit with Returns', () => {
    ...
    const lines: (LineInput & { id: number })[] = [
      { id: 1, sell_price_amount: 150, unit_cost_price: 100, quantity: 10, line_discount_amount: 0 }, // GP: 500, cost: 100
    ]
  ...
  describe('batchPnl', () => {
    ...
    const shipmentItems: ShipmentItemInput[] = [
      { id: 1, received_qty: 10, landed_unit_cost: 80 },
    ]
