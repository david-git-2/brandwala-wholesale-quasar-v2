  ...
  >
    ...
    <div v-else-if="payment" class="row q-col-gutter-lg">
      ...
      <div class="col-12 col-md-4">
        <q-card flat bordered class="q-pa-md q-gutter-y-md bg-white">
          <div class="text-subtitle1 text-weight-bold pb-2 text-primary">Payment Summary</div>

          <div class="row justify-between">
            <span class="text-grey-7">Customer:</span>
            <span class="text-weight-bold">{{
              payment.billing_profile?.name || 'Walk-in / Direct'
            }}</span>
          </div>
          <div class="row justify-between">
          ...
          <div class="border-t pt-4 q-mt-md q-gutter-y-sm">
            <div class="row justify-between items-center">
              ...
              <span class="text-h6 text-weight-bold text-primary">{{
                formatAmountBdt(payment.amount)
              }}</span>
            </div>
            <div class="row justify-between items-center">
              <span class="text-grey-7">Unallocated Balance:</span>
              <span class="text-h6 text-weight-bold text-warning">{{
                formatAmountBdt(payment.unallocated_amount)
              }}</span>
            </div>
          </div>
            ...
            <q-markup-table flat bordered wrap-cells style="min-width: 700px">
              ...
              <tbody>
                ...
                <tr v-for="alloc in allocations" :key="alloc.id">
                  ...
                  <td class="text-right">
                    {{
                      alloc.global_invoice?.total_amount
                        ? formatAmountBdt(alloc.global_invoice.total_amount)
                        : '-'
                    }}
                  </td>
    ...
    <q-dialog v-model="allocateDialogOpen" persistent>
      <q-card style="width: 700px; max-width: 95vw">
        ...
        <q-card-section>
          <div
            class="row items-center justify-between bg-amber-1 q-pa-md rounded border border-warning q-mb-lg"
          >
            <div>
            ...
            <div class="text-right">
              ...
              <div class="text-h5 text-weight-bold text-primary">
                {{ formatAmountBdt(enteringAllocTotal) }}
              </div>
            </div>
          </div>
              ...
              <tbody>
                ...
                <tr v-for="inv in unpaidInvoices" :key="inv.id">
                  ...
                  <td class="text-right text-weight-bold text-negative">
                    {{ formatAmountBdt(inv.due_amount) }}
                  </td>
                  <td class="text-right">
                    <q-input
          ...
          <div class="row justify-between items-center q-mt-lg">
            ...
            <div class="row items-center">
              ...
              <q-btn
                ...
                :disable="
                  enteringAllocTotal <= 0 || enteringAllocTotal > payment.unallocated_amount
                "
                :loading="allocating"
