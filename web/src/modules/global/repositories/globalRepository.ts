...
const listGlobalStockPage = async (payload: GlobalStockListQuery): Promise<GlobalStockListPage> => {
...
const listChildStockAllocations = async (
  ...
  const { data, error } = await supabase
    ...
    .select(
      'id, parent_tenant_id, child_tenant_id, stock_id, status, quantity, is_display_only, created_at, updated_at',
    )
