...
const shipmentLabel = computed(() => {
  const shipment = props.item?.shipment?.shipment as { tenant_shipment_id?: number; id?: number; name?: string } | null
...
@media (max-width: 599px) {
  .border-right-light { border-right: none; border-bottom: 1px solid rgba(0, 0, 0, 0.08); padding-bottom: 12px; margin-bottom: 12px; }
}
.soft-qty-card { border: 1px solid rgba(0,0,0,0.06); }
</style>
