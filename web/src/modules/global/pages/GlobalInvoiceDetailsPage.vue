    ...
    <q-dialog v-model="returnDialog" persistent>
      <q-card class="q-pa-md" style="min-width: 400px; border-radius: 16px;">
        ...
        <q-card-section class="q-gutter-y-sm">
          ...
          <q-input v-slot:default v-model.number="returnFaceAmount" type="number" label="Customer Refund Amount (Face)" outlined dense min="0" class="soft-input" />
          <q-input v-slot:default v-model.number="returnAccountingAmount" type="number" label="Seller Deduction Amount (Accounting)" outlined dense min="0" class="soft-input" />
