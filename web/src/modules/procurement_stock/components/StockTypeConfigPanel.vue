    ...
    <q-card class="q-dialog-plugin" style="width: 700px; max-width: 90vw;">
      <q-card-section class="row items-center q-pb-none">
        <div>
          ...
          <div class="text-caption text-grey-7">Manage usability labels and sellable state for inventory batches</div>
        </div>
        <q-space />
...
const columns: QTableColumn[] = [
  ...
  { name: 'parent_tenant_id', label: 'Scope', field: 'parent_tenant_id', align: 'left', sortable: true },
