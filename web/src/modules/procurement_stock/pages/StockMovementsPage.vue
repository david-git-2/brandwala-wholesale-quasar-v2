<template>
  <q-page class="bw-page">
    <section class="bw-page__stack" style="min-width: 0">
      ...
      <q-card v-else flat bordered class="q-pa-none overflow-hidden">
        <q-table
          flat
          :rows="movements"
          :columns="columns"
          ...
          <template #body-cell-status="props">
            <q-td :props="props" class="cursor-pointer">
              <q-chip
                dense
                square
                :color="props.row.is_posted ? 'green-1' : 'grey-2'"
                :text-color="props.row.is_posted ? 'green-9' : 'grey-8'"
                :label="props.row.is_posted ? 'Posted' : 'Draft'"
              />
            </q-td>
          </template>
