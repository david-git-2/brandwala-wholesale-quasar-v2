        ...
        <div class="row q-col-gutter-md q-mt-md">
          <div class="col-12 col-sm-6">
            ...
            <q-card flat bordered class="q-pa-md bg-white text-grey-9 shadow-1">
              ...
              <!-- 1. Shipment totals -->
              <div class="q-mb-md">
                <div class="text-xs text-weight-bold text-grey-6 uppercase q-mb-xs" style="font-size: 11px; letter-spacing: 0.5px;">Shipment Totals</div>
              ...
              <!-- 2. Purchase currency -->
              <div class="q-mb-md">
                <div class="text-xs text-weight-bold text-grey-6 uppercase q-mb-xs" style="font-size: 11px; letter-spacing: 0.5px;">Purchase Currency ({{ currentPurchaseCurrencySymbol }})</div>
                <div class="row justify-between q-py-xs">
                ...
                <div class="row justify-between q-py-xs" v-if="shipmentStore.currentShipment?.cargo_rate > 0">
                ...
                <div class="row justify-between q-py-xs bg-grey-1 q-px-sm rounded-borders">
                  <span class="text-caption text-weight-medium text-grey-8">Total Purchase Cost:</span>
              ...
              <template v-if="shipmentStore.currentShipment?.type === 'international'">
                ...
                <!-- 3. Cost currency -->
                <div class="q-mb-md">
                  <div class="text-xs text-weight-bold text-grey-6 uppercase q-mb-xs" style="font-size: 11px; letter-spacing: 0.5px;">Cost Currency ({{ currentCostCurrencySymbol }})</div>
                  <div class="row justify-between q-py-xs">
                  ...
                  <div class="row justify-between items-center q-py-sm bg-primary text-white q-px-sm rounded-borders">
                ...
                <div class="bg-blue-1 text-blue-10 q-pa-sm rounded-borders text-center">
                  <div class="text-caption text-weight-medium uppercase" style="font-size: 10px; letter-spacing: 0.5px;">Live Blended Transaction Rate</div>
          ...
          <q-card-section class="q-pa-md">
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="bg-grey-1 q-pa-sm rounded-borders q-gutter-y-xs text-grey-9 text-caption">
                  <div class="row justify-between">
                    <span>Product Purchase:</span>
                    <span class="text-weight-bold">{{ currentPurchaseCurrencySymbol }}{{ ratesPreview.goodsPurchase.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span>
                  </div>
                  <div class="row justify-between" v-if="shipmentStore.currentShipment?.type === 'international'">
                    <span>Product Converted Cost:</span>
                    <span class="text-weight-bold">{{ currentCostCurrencySymbol }}{{ ratesPreview.goodsCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span>
                  </div>
                  ...
                  <div class="row justify-between">
                    ...
                    <span class="text-weight-bold">{{ currentPurchaseCurrencySymbol }}{{ ratesPreview.cargoPurchase.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span>
                  </div>
                  <div class="row justify-between" v-if="shipmentStore.currentShipment?.type === 'international'">
                    <span>Cargo Converted Cost:</span>
                    <span class="text-weight-bold">{{ currentCostCurrencySymbol }}{{ ratesPreview.cargoCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span>
                  </div>
                  <q-separator class="q-my-xs" />
                  <div class="row justify-between text-subtitle2 text-weight-bold bg-primary text-white q-pa-xs rounded-borders">
                    <span>Total Cost:</span>
                    <span>{{ shipmentStore.currentShipment?.type === 'international' ? currentCostCurrencySymbol : currentPurchaseCurrencySymbol }}{{ ratesPreview.totalCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</span>
                  </div>
                </div>

                <div class="bg-blue-1 text-blue-10 q-pa-sm rounded-borders text-center q-mt-md" v-if="shipmentStore.currentShipment?.type === 'international'">
                  <div class="text-caption text-weight-medium uppercase" style="font-size: 9px; letter-spacing: 0.5px;">Calculated Transaction Rate</div>
