...
.auth-card--app {
  ...
  --card-soft: rgb(3 181 170 / 0.12);
  border-color: rgb(107 109 118 / 0.22);
}
.auth-card--shop {
  --card-accent: #996888;
...
.auth-card--app .auth-card__title {
  color: #33261d;
}

.auth-card--app .auth-card__subtitle {
  color: #6b6d76;
}

.auth-card--app .auth-card__cta-label {
  color: #33261d;
}
