...
const updateCostingFileItem = async (
  ...
  if (payload.deliveryPriceGbp !== undefined)
    updateData.delivery_price_gbp = payload.deliveryPriceGbp;
  if (payload.auxiliaryPriceGbp !== undefined)
    updateData.auxiliary_price_gbp = payload.auxiliaryPriceGbp;
  ...
  if (payload.customerProfitRate !== undefined)
    updateData.customer_profit_rate = payload.customerProfitRate;
