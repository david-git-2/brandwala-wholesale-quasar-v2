...
const hubCards: HubCard[] = [
  {
    ...
    path: 'modules',
    title: 'Modules',
    caption: 'Enable workspace features for this tenant.',
  ...
  },
  {
    ...
    path: 'roles',
    title: 'Roles',
    caption: 'Define roles and what each role can do.',
  ...
  },
  {
    ...
    path: 'team',
    title: 'Team',
    caption: 'Invite staff and assign workspace roles.',
    icon: 'ph ph-users',
  ...
  },
  {
    ...
    caption: 'Group customers for shop access and pricing.',
  ...
  },
  {
    ...
    caption: 'Grant read-only portal access to investors.',
...
const goTo = (path: string) => {
  void router.push(`${getTenantPrefix()}/app/access-control/${path}`);
};
</script>
