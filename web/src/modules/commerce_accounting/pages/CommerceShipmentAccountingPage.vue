<template>
  <q-page class="q-pa-md shipment-acct-list-page" style="background: transparent;">
    ...
    <div class="row items-center justify-between q-mb-md">
      <div>
        <div class="text-h6 text-weight-bold">Commerce Shipment Accounting</div>
        <div class="text-caption text-grey-7">Select a shipment to view commerce P&amp;L accounting</div>
      </div>
    </div>
