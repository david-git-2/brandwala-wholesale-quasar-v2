        ...
        <div class="row items-center justify-between q-col-gutter-sm">
          <div class="col-12 col-sm row items-center no-wrap">
            ...
            <div style="min-width: 0">
              <div
                class="text-h6 text-weight-bold text-ellipsis overflow-hidden"
                style="white-space: nowrap"
              >
                {{ isEdit ? 'Edit Vendor Details' : 'Loading...' }}
              </div>
              <div
                class="text-caption text-grey-8 text-ellipsis overflow-hidden"
                v-if="vendorData"
                style="white-space: nowrap"
              >
                {{ form.name }} ({{ form.code }})
          ...
          <div
            class="col-12 col-sm-auto row items-center justify-end q-gutter-x-sm q-mt-xs q-mt-sm-none"
          >
            <q-btn
              color="negative"
              no-caps
            ...
            <div class="row q-col-gutter-sm q-mb-md items-center">
              ...
              <div class="col-auto">
                <q-btn
                  color="primary"
                  label="Add"
                  :disable="!newBrandName.trim() || isAddingBrand"
                  @click="addBrand"
      ...
      <div class="col-12 col-md-6">
        <q-card flat class="floating-surface shadow-1 full-height">
          <q-card-section>
            ...
            <div class="row q-col-gutter-sm q-mb-md items-center">
              ...
              <div class="col-auto">
                <q-btn
                  color="primary"
                  label="Add"
                  :disable="!newCategoryName.trim() || isAddingCategory"
                  @click="addCategory"
            ...
            <div v-else-if="categories.length === 0" class="text-grey-7">
...
const runCodeCheck = () => {
  ...
  debounceTimer = setTimeout(() => {
    void (async () => {
      ...
      try {
        const result = await vendorStore.checkCodeAvailability(
