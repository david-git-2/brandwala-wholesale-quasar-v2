...
## Feature Description
The user will provide the feature description in the message that triggered this workflow. If no description was provided, ask for it now before proceeding.
