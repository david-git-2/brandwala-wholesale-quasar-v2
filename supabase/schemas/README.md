...
| `tenants/` `permissions/` `shop/` `shop_order/` `sales_invoice/` `thrift/` `wallet/` `investor/` `global_reference/` `tag/` | Stubs — move objects here when you change that module; delete them from `public.sql` in the same PR |
