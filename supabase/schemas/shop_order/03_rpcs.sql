...
CREATE OR REPLACE FUNCTION "public"."shop_shipment_alloc_visible_to_tenant"("p_assigned_child_tenant_id" bigint, "p_shop_tenant_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE
...
ALTER FUNCTION "public"."shop_shipment_alloc_visible_to_tenant"("p_assigned_child_tenant_id" bigint, "p_shop_tenant_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."shop_product_grade_available_units"("p_shop_tenant_id" bigint, "p_product_id" bigint, "p_grade_tag_id" bigint DEFAULT NULL::bigint) RETURNS integer
...
CREATE OR REPLACE FUNCTION "public"."browse_shop_catalog_for_admin"("p_tenant_id" bigint, "p_shop_id" bigint, "p_search" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 24, "p_offset" integer DEFAULT 0, "p_include_below_min_units" boolean DEFAULT false) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
CREATE OR REPLACE FUNCTION "public"."can_act_on_parent_tenant_stock"("p_parent_tenant_id" bigint) RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."purge_shop_order_wallet_ledger"("p_order_id" bigint, "p_tenant_id" bigint, "p_order_no" "text", "p_invoice_id" bigint, "p_invoice_no" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."purge_shop_order_invoice"("p_invoice_id" bigint) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."purge_shop_order_invoice"("p_invoice_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."purge_shop_order_financial_artifacts"("p_order_id" bigint) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."purge_shop_order_financial_artifacts"("p_order_id" bigint) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_dropship_shop_cart"("p_shop_id" bigint) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."get_dropship_shop_cart"("p_shop_id" bigint) OWNER TO "postgres";
...
ALTER FUNCTION "public"."submit_dropship_order_from_cart"(
  "p_shop_id" bigint,
  "p_recipient_name" "text",
  "p_recipient_phone" "text",
  "p_shipping_address" "text",
  "p_recipient_phone_secondary" "text",
  "p_shipping_district" "text",
  "p_shipping_thana" "text",
  "p_shipping_post_code" "text",
  "p_billing_profile_id" bigint,
  "p_is_prepaid" boolean,
  "p_delivery_instructions" "text",
  "p_cod_charge_amount" numeric,
  "p_delivery_charge_amount" numeric,
  "p_print_charge_amount" numeric,
  "p_packing_charge_amount" numeric,
...
ALTER FUNCTION "public"."list_allocated_stock_for_shop"("p_shop_id" bigint, "p_search" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_shop_storefront_listing_price_calculation"("p_shop_id" bigint, "p_listing_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."list_shop_storefront_listings_for_admin"("p_shop_id" bigint, "p_search" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 200, "p_offset" integer DEFAULT 0) RETURNS "jsonb"
LANGUAGE plpgsql
STABLE
SECURITY DEFINER
SET search_path = public
