...
CREATE OR REPLACE FUNCTION "public"."get_shipment_item_invoices"("p_tenant_id" bigint, "p_shipment_id" bigint) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."get_shipment_item_invoices"("p_tenant_id" bigint, "p_shipment_id" bigint) OWNER TO "postgres";
