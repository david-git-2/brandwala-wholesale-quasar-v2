...
ALTER FUNCTION public.get_staff_investor_capital_metrics(bigint) OWNER TO postgres;
...
ALTER FUNCTION public.get_tasks_dashboard_metrics(bigint) OWNER TO postgres;
...
-- ==============================================================================
-- TENANT OPERATIONAL DATA PURGE ENGINE
-- ==============================================================================
...
GRANT ALL ON TABLE "public"."tenant_data_purge_logs" TO "authenticated";
