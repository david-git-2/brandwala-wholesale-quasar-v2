-- Allow any customer group member to insert costing file items into draft costing files of their group
...
-- Allow any customer group member to delete costing file items from draft costing files of their group
...
-- Allow any customer group member to delete draft costing files of their group
...
-- Update create_costing_file_item_request function to allow any customer group member to insert
