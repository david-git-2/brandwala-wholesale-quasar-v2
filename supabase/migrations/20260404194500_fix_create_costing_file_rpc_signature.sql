-- Keep the staff/customer create flow working with the RPC signature
-- order that PostgREST resolves for named parameters.

drop function if exists public.create_costing_file(bigint, bigint, text, text, public.costing_file_status);
