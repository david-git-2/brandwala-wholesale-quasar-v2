-- Migration: Exclude expired items from list_store_product_pricing RPC
begin;
...
begin
  with target_batches as (
    -- Filter active inventory items and exclude expired ones
    ...
    where ii.tenant_id = p_tenant_id
      ...
      and (ii.expire_date is null or ii.expire_date >= current_date)
