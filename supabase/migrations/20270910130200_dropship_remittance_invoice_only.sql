-- Dropship remittance: pay B2B invoice only — do not track reseller profit on remittance metadata or payment notes.
-- Reseller profit is credited separately via transfer_dropship_reseller_profit (step ③).
