-- Redefine browse_shop_catalog to show display quantity override instead of actual quantity for dropship stores
              ...
              select jsonb_agg(
                jsonb_build_object(
                  ...
                  'available_units', case 
                    ...
                    when $8 = 'dropship' then coalesce(p.display_quantity_override, greatest(0, p.available_qty))
