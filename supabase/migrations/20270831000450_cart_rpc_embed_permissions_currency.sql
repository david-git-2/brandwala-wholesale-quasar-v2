-- Embed live permissions and shop sell currency in get_or_create_shop_cart (Option A).
-- Cart page no longer needs separate get_shop_permissions_for_customer or global_currencies calls.
