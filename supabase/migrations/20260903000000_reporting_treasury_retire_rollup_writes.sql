...
-- =========================================================
-- Redefine post_global_invoice to remove rollup write
-- =========================================================
...
-- =========================================================
-- Redefine void_global_invoice to remove rollup write
-- =========================================================
...
-- =========================================================
-- Redefine add_global_return_item to remove rollup write
-- =========================================================
...
-- =========================================================
-- Drop the deprecated refresh_global_invoice_accounting function
-- =========================================================
drop function if exists public.refresh_global_invoice_accounting(bigint) cascade;
