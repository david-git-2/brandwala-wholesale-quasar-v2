-- Migration: Fix invalid column 'is_default' in dropship profit calculation
-- Issue: record "v_invoice" has no field "middle_man_payout_amount" (resolved in previous migration)
-- Follow-up Issue: 42703 column "is_default" does not exist
