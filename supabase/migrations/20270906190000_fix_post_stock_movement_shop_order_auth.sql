-- post_stock_movement re-checked auth without shop-order context after create_and_post passed.
...
GRANT EXECUTE ON FUNCTION public.can_act_on_stock_movement_context(bigint, text, text) TO authenticated;
