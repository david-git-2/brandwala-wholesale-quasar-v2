-- confirm_dropship_delivered_costing referenced shop_orders.courier_notes (missing); use driver_notes
...
begin
  ...
  v_courier_id := coalesce(
    (
      ...
      left join public.couriers c on c.code = cs.code or c.name = cs.name
