-- =========================================================
-- Admin visibility update for customer lifecycle statuses.
-- Admin can view customer-created files when status is:
-- customer_submitted, offered, completed, cancelled.
-- =========================================================
