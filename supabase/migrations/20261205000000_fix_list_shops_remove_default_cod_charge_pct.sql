-- Migration: Update list_shops RPC to ensure s.default_cod_charge_pct is not referenced
-- In migration 20261114000000_remove_shop_cod_delivery_sender_defaults.sql, default_cod_charge_pct was dropped from public.shops.
-- This migration updates list_shops to exclude default_cod_charge_pct.
