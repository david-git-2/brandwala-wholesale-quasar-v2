-- Migration to update status counts in list_items_paginated to only include tasks
begin;
...
-- 2. Recreate list_items_paginated with status counts restricted to type = 'task'
