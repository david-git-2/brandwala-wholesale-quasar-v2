-- Migration: 20270831000130_fix_process_wholesale_invoice_return_issued_status.sql
-- Description: Update process_wholesale_invoice_return to use 'issued' instead of 'posted'
...
begin
  ...
  if v_invoice.invoice_status <> 'issued'::public.global_invoice_status then
    raise exception 'Returns can only be processed on issued invoices';
  end if;
