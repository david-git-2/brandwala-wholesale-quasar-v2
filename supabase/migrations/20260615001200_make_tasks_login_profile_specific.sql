-- Migration to make tasks login-profile specific (ignore tenant filtering in pagination RPC)
begin;
...
-- 2. Recreate list_items_paginated ignoring p_tenant_id filter for items
