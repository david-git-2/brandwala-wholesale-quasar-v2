-- Migration to fix cascade deletion error on product_based_costing_files / items
-- When a costing file or item is deleted, upsert_pbc_backlog_from_item was throwing 'costing item % not found' exception.
...
BEGIN
  ...
  -- If item was deleted, safely return NULL
  ...
  -- If parent file was deleted, safely return NULL
