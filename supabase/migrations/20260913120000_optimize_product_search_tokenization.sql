-- Migration to optimize product search in list_products_paginated by splitting the search query into tokens
-- and ensuring all tokens must match in any order (fuzzy/tokenized search).
