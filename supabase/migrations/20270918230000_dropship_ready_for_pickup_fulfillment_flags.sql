-- Ready-for-pickup needs pick/unavailable flags on dropship detail items.
...
GRANT ALL ON FUNCTION public.get_dropship_order_detail_v2(bigint, bigint) TO service_role;
