-- Migration: Fix get_tenant_shipment_profit_report RPC column names
-- Description: Updates column references from non-existent unit_cost_bdt/quantity to authoritative landed_cost_bdt, ordered_quantity/received_quantity, and name.
