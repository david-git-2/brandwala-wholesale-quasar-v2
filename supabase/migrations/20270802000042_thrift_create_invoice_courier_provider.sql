-- Migration: create_thrift_sales_invoice — courier_provider_id + meta
-- Depends on: 20270802000039, 20270802000041
...
COMMENT ON FUNCTION public.create_thrift_sales_invoice(
  ...
  'Create thrift sales invoice. Offline: PAID + PnL DELIVERED. Online: COD_PENDING/PENDING, courier catalog, fee EXPENSEs, no PnL yet.';
