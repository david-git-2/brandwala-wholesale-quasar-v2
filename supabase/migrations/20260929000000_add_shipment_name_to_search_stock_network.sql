-- Migration to add shipment_name to search_stock_network return type and queries.
...
begin
  ...
  with matched_stocks as (
    ...
    group by gs.id, gsi.product_id, gsi.name, gsi.barcode, gsi.product_code, gsi.image_url, gsi.purchase_price, gsi.product_weight, gsi.package_weight, gsi.shipment_id, sh.name, sh.type, sh.cargo_rate, sh.transaction_rate, sh.product_conversion_rate, sh.cargo_conversion_rate
    having (
