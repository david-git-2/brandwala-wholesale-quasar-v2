-- Align get_dropship_order_detail_v2 with shop_order_items columns (money-story).
-- Merchant sell = unit_sell_price_amount; resell = customer_sell_price_amount;
-- cost = resolve_shop_order_item_landed_cost. unit_buy_price_amount does not exist.
