-- Migration: Fix customer_group_id foreign key constraint violation in add_commerce_invoice_item RPC by inserting NULL instead of 0
begin;
...
begin
  ...
  values (
    ...
    p_sell_price_bdt,
    p_recipient_price_bdt,
    v_cust_group_id, -- Keep NULL if not present instead of coercing to 0
