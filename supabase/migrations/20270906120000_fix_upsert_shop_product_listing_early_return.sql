-- Fix upsert_shop_product_listing: product-only listing updates must return after RETURN QUERY.
-- Without RETURN, execution fell through and raised "product or stock required".
