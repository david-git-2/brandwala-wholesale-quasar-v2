-- Migration to add RPCs for atomic bulk insertion and updating of global_shipment_items

begin;

-- 1. Bulk Add RPC: bulk_add_global_shipment_items
...
grant execute on function public.bulk_add_global_shipment_items(bigint, jsonb) to authenticated, service_role;

-- 2. Bulk Update RPC: bulk_update_global_shipment_items
...
grant execute on function public.bulk_update_global_shipment_items(bigint, jsonb) to authenticated, service_role;
