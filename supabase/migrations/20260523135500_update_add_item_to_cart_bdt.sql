drop function if exists public.add_item_to_cart(
  bigint,
  bigint,
  bigint,
  boolean,
...
create or replace function public.add_item_to_cart(
  ...
  p_price_bdt numeric default null,
  p_minimum_sell_price_bdt numeric default null,
...
begin
  ...
  if v_effective_price_bdt is not null
     and v_effective_min_sell_bdt is not null
     and v_effective_price_bdt < v_effective_min_sell_bdt then
    raise exception 'Price cannot be less than minimum sell price.'
      using errcode = 'P0001';
  end if;
