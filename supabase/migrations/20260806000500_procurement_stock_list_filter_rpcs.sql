...
-- =========================================================
-- 1. list_global_stocks_paginated
-- =========================================================
...
grant execute on function public.list_global_stocks_paginated(bigint, integer, integer, text, bigint, boolean, text) to authenticated;

-- =========================================================
-- 2. list_global_stock_allocations_paginated
-- =========================================================
