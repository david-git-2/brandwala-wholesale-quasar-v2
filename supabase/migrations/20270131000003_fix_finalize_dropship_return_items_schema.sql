-- Hotfix: finalize_dropship_return INSERT must match global_return_items
-- (no return_amount / return_face_amount / return_accounting_amount).
-- Re-applies function body after 20270131000002 for DBs that already ran the broken version.
