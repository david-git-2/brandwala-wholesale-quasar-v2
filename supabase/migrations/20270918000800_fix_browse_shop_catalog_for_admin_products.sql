-- Restore browse_shop_catalog_for_admin to query public.products (vendor_catalog scope).
-- Reverts the broken vendors/brands/categories join from 20270915232000.
...
GRANT ALL ON FUNCTION "public"."browse_shop_catalog_for_admin"(
  "p_tenant_id" bigint,
  "p_shop_id" bigint,
  "p_search" "text",
  "p_limit" integer,
