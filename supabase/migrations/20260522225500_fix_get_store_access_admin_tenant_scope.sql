-- =========================================================
-- Harden store access admin RPC with tenant filter
-- =========================================================

drop function if exists public.get_store_access_admin(bigint);
drop function if exists public.get_store_access_admin(bigint, bigint);
...
grant execute on function public.get_store_access_admin(bigint, bigint)
to authenticated;
