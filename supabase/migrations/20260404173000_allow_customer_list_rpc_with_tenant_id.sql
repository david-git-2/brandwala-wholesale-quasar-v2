-- Allow customer list calls to include tenant id together with customer group id.
-- This keeps customer visibility rules intact while supporting stricter request context.
