-- Fix browse_shop_catalog vendor_catalog branch: search used trim($2) but $2 is v_tenant_id (bigint).
-- $3 is p_search. Triggers: function pg_catalog.btrim(bigint) does not exist (42883).
