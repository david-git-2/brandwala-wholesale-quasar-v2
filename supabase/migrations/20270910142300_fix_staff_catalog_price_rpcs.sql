-- 20270201010000_catalog_negotiation_rpcs_p1.sql regressed to non-existent shop_order_items columns
-- (gross_weight_kg, cbm, final_offer_amount). Restore catalog negotiation RPCs per CATALOG_NEGOTIATION.md.
