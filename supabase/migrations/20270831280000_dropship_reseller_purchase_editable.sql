-- Reseller purchase cost: default from order sell prices, allow staff override via payload
...
begin
  ...
  select coalesce(
    sum(coalesce(soi.unit_sell_price_amount, 0) * soi.quantity),
    0
  )
  into v_default_reseller_purchase_cost
