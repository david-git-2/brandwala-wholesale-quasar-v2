-- Parent-tenant admins can preview vendor catalog storefront on child shops
-- (matches upsert_shop_customer_group_access and list_shop_storefront_listings_for_admin).
