alter table public.inventory_stocks
  add column if not exists open_box_quantity integer not null default 0;

update public.inventory_stocks
set open_box_quantity = greatest(open_box_quantity, 0)
where open_box_quantity is null or open_box_quantity < 0;

alter table public.inventory_items
  drop column if exists is_open_box;
