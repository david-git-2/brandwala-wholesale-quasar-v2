-- Add p_extra_origin_purchase_expense legacy alias to register_thrift_stock_from_app
begin;
...
grant execute on function public.register_thrift_stock_from_app(
  bigint, text, bigint, text, text, bigint, bigint, text, bigint, text, text, text,
  bigint, numeric, numeric, text, numeric, numeric, numeric, numeric, text, numeric, numeric, numeric, numeric
) to authenticated;
