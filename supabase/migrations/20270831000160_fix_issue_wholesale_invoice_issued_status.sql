-- Migration: 20270831000160_fix_issue_wholesale_invoice_issued_status.sql
-- Description: Ensure issue_wholesale_invoice sets status to 'issued'::public.global_invoice_status
