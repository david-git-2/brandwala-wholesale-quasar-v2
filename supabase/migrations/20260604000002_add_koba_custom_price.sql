...
alter table public.koba_cart_items
add column if not exists custom_price_gbp numeric(12,2) null;

alter table public.koba_order_items
add column if not exists custom_price_gbp numeric(12,2) null;

drop function if exists public.place_koba_order(bigint, bigint, text, text, text, text, text, boolean, numeric, numeric, numeric, numeric, numeric, numeric, numeric);
