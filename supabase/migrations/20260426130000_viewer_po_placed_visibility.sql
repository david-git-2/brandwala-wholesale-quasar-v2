-- =========================================================
-- Viewer visibility: po_placed compatibility
-- Viewers assigned to a costing file should be able to see it
-- (and its items) when status is po_placed. Keep legacy
-- completed compatibility during transition.
-- =========================================================
