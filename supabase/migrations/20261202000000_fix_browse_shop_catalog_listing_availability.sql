-- Migration: Remove p.is_available restriction from shop_product_listings in browse_shop_catalog
-- Active shop listings (l.is_active = true) drive storefront catalog visibility.
