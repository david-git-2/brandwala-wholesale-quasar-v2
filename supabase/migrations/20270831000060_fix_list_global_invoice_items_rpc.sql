-- Migration: 20270831000060_fix_list_global_invoice_items_rpc.sql
-- Description: Fix list_global_invoice_items RPC to query sales_invoices without non-existent tenant_id column

CREATE OR REPLACE FUNCTION "public"."list_global_invoice_items"("p_invoice_id" bigint) RETURNS TABLE(
  "id" bigint,
  "invoice_id" bigint,
