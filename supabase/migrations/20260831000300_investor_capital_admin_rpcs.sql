...
grant execute on function public.list_investor_profiles(bigint, int, int, text) to authenticated;

-- =========================================================
-- 2. upsert_investor_profile
-- =========================================================
...
-- =========================================================
-- 4. record_investor_withdrawal_paid
-- =========================================================
...
-- =========================================================
-- 5. record_investor_capital_adjustment
-- =========================================================
...
grant execute on function public.record_investor_capital_adjustment(bigint, bigint, numeric, date, public.investor_payment_method, text) to authenticated;

-- =========================================================
-- 6. upsert_shipment_investment
-- =========================================================
...
begin
  ...
  -- Validate total cost shares <= 100% per global shipment
  ...
  -- Recompute profit allocations on this shipment batch
  perform public.refresh_shipment_investor_profits(p_global_shipment_id);

  -- Fetch the updated cost and profit figures
...
grant execute on function public.upsert_shipment_investment(bigint, bigint, bigint, bigint, numeric) to authenticated;

-- =========================================================
-- 7. get_investor_capital_report
-- =========================================================
...
begin
  ...
  -- Starting balance calculations (balance before p_start_date)
...
grant execute on function public.get_investor_capital_report(bigint, bigint, date, date) to authenticated;
